   ...
   public class Program
    {
        public Program()
        {
            ...
            osobe[1] = new Predavac() { Ime = "Karla", IBAN = "HR9128102" };
            osobe[2] = new Predavac() { Ime = "Lota", IBAN = "HR91323232" };
            osobe[3] = new Polaznik() { Ime = "Ivana", Telefon = "232322" };
            osobe[4] = new Predavac() { Ime = "Josip", IBAN = "HR913422262" };
